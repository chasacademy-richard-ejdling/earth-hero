...
import { useRegisterAndLogin, setOnRegister, setOnLogin } from "./redux/registerAndLogin";
            ...
            {register ? (
                ...
                <div className="flex flex-col justify-between h-screen">
                    ...
                    <div className="flex flex-col gap-3 items-center mb-24">
                        <button className="bg-gray-200 hover:bg-gray-300 text-black rounded-full px-3 py-1 w-fit" onClick={() => setOnLogin(true)}>Logga in</button>
                        <button className="bg-gray-200 hover:bg-gray-300 text-black rounded-full px-3 py-1 w-fit" onClick={() => setOnRegister(true)}>Registrera dig</button>
                    </div>
                </div>
            ) : (
                <div className="">
